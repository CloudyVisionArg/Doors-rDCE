...
AppVerName=Gestar Remote DCE 7.2.53
...
; comdlg32.ocx
Source:  dep\comdlg32.ocx; DestDir: {sys}; Flags: regserver sharedfile restartreplace
;Source:  dep\comcat.dll; DestDir: {sys}; Flags: regserver sharedfile restartreplace
